    ...
    this.template = `
      <div class="settings">
        ...
        <div class="settings__item">
          ...
          <label class="switch">
            <input type="checkbox" class="toggle-sound" ${obj.toggleSound}>
            <span class="slider"></span>
          </label>
        </div>
        <div class="settings__progr">
          <span class="volume"></span>
          <input class="progress vol-progr" type="range" value=${obj.volume} step="1" disabled>
          <span class="volume vol-up"></span>
        </div>
        <div class="settings__item">
          <span class="settings-item__text">Игра на время</span>
          <label class="switch">
            <input type="checkbox" class="toggle-timer" ${obj.toggleTimer}>
            <span class="slider"></span>
          </label>
        </div>
        <div class="settings__progr">
